...
class FullMailbox extends Resource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'gmailProjectId' => $this->gmail_project_id,
            'gmailClientId' => $this->gmail_client_id,
//            'gmailClientSecret' => $this->gmail_client_secret,
            'gmailClientSecret' => '',
            'gmailRedirectUrl' => $this->gmail_redirect_url,
