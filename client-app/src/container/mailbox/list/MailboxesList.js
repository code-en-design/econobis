                ...
                <DataTable>
                    <DataTableHead>
                        <tr className="thead-title">
                            ...
                            <DataTableHeadTitle title={'Server inkomend'} width={'10%'} />
                            <DataTableHeadTitle title={'Server uitgaand'} width={'10%'} />
                            <DataTableHeadTitle title={'Gebruikersnaam'} width={'15%'} />
                            <DataTableHeadTitle title={'Inkomend'} width={'10%'} />
                            <DataTableHeadTitle title={'Uitgaand'} width={'10%'} />
